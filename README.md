...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mkdocstrings-python-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mkdocstrings-python-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mkdocstrings-python
# for installing globally
pixi global install mkdocstrings-python
```
...
It is possible to list all of the versions of `mkdocstrings-python` available on your platform:
...
```
pixi search mkdocstrings-python --channel conda-forge
```
